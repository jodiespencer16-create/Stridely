...
const Footer = () => {
  return (
    <footer className="bg-[#2B2B2B] text-white pt-10 pb-6">
      <div className="max-w-4xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 pb-6">
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="w-6 h-6 bg-white rounded flex items-center justify-center">
                <svg className="w-4 h-4 text-neutral-dark" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/>
                </svg>
              </div>
              <span className="text-sm font-bold">WeCan</span>
            </div>
            <p className="text-xs text-white/60 mb-3 leading-relaxed">
              Optima is the world's leading community for creatives to share, grow, and get hired.
            </p>
            <div className="flex gap-2">
              <a href="#" className="hover:text-[#1A7B7B] transition">
                <svg className="w-4 h-4 text-[#4A9EFF]" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            <h3 className="font-semibold mb-2 text-xs">Our Products</h3>
          ...
          <div>
            <h3 className="font-semibold mb-2 text-xs">Top Features</h3>
            <ul className="space-y-1 text-xs text-white/60">
          ...
          <div>
            <h3 className="font-semibold mb-2 text-xs">Company</h3>
            <ul className="space-y-1 text-xs text-white/60">
          ...
          <div>
            <h3 className="font-semibold mb-2 text-xs">Favourite Things</h3>
            <ul className="space-y-1 text-xs text-white/60">
        ...
        <div className="pt-4 border-t border-white/10 text-center">
          <p className="text-xs text-white/40">© Copyright 2021. Localio. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
