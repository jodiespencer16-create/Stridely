        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 pb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-base font-bold">WeCan</span>
            </div>
          ...
          <div>
            <h3 className="font-semibold mb-3 text-sm">Our Products</h3>
          ...
          <div>
            <h3 className="font-semibold mb-3 text-sm">Top Features</h3>
            <ul className="space-y-2 text-xs text-white/60">
          ...
          <div>
            <h3 className="font-semibold mb-3 text-sm">Favourite Things</h3>
            <ul className="space-y-2 text-xs text-white/60">
